...
int         reverse_rotate_rec_rra(t_list *stack_a, t_list *stack_b, int set_depth, t_comm **command_list)
{
...
int         reverse_rotate_rec_rrb(t_list *stack_a, t_list *stack_b, int set_depth, t_comm **command_list)
{
...
int         reverse_rotate_rec_rrr(t_list *stack_a, t_list *stack_b, int set_depth, t_comm **command_list)
{

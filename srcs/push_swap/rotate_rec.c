...
int         rotate_rec_ra(t_list *stack_a, t_list *stack_b, int set_depth, t_comm **command_list)
{
...
int         rotate_rec_rb(t_list *stack_a, t_list *stack_b, int set_depth, t_comm **command_list)
{
...
int         rotate_rec_rr(t_list *stack_a, t_list *stack_b, int set_depth, t_comm **command_list)
{
